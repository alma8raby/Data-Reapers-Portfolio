...
const translations = {
  ...
  ar: {
    ...
    results_label: "نماذج الرؤى",
    results_title: "النتائج الاستكشافية",
    results_desc: "عرض للارتباطات الأولية ونماذج سلوكية استكشافية تم تحليلها من البيانات الرقمية للجيل زد.",
    ...
    dashboard_desc: "لوحة تحليلات تفاعلية تجمع بين مقاييس السلوك الرقمي متعدد الأبعاد ومؤشرات الصحة النفسية.",
    ...
    dashboard_open_btn: "عرض ملء الشاشة",
    ...
    research_s2_stat_label: "فترة التعافي",
    ...
    team_role_4: "تصور البيانات والتقارير",
    ...
    team_skill_1_4: "رؤى الأبحاث",
    team_skill_1_3: "الربط التحليلي",
    team_skill_2_1: "نمذجة البيانات",
    team_skill_2_2: "تصميم المخطط",
    team_skill_2_3: "هندسة الخصائص",
    team_skill_3_1: "التحقق من البيانات",
